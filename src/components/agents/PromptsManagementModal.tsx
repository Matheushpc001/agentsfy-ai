      ...
      `}>
        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <Tabs defaultValue="all" value={activeNiche} onValueChange={setActiveNiche} className="flex-1 flex flex-col min-h-0">
                ...
                <div className="pb-2">
                  ...
                  `}>
                    <TabsTrigger 
                      value="all" 
                      className={`
                        ${isMobile ? 'text-sm px-3 py-2 h-auto' : 'text-sm px-3 py-2'}
                    ...
                    {allNiches.map((niche) => {
                      ...
                      return (
                        <TabsTrigger 
                          ...
                          `}
                        >
                          <span className={`${isMobile ? 'max-w-[80px]' : 'max-w-[60px]'} truncate`}>
                            {niche}
                          </span>
            ...
            <TabsContent value={activeNiche} className="flex-1 min-h-0 mt-0">

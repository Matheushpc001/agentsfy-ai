...
export default function PlanInfoCard({
  ...
  if (compact) {
    return (
      <div className="bg-white dark:bg-gray-800 border rounded-lg p-3 flex items-center justify-between gap-3">
        <div className="min-w-0 flex-1">
          <h3 className="font-medium text-sm truncate">{planName}</h3>
          <div className="flex justify-between text-xs mb-1">
            <span>{totalAgents} agentes</span>
